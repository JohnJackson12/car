...
class PlaybackService : Service() {
    ...
    override fun onCreate() {
        ...
        voice.listener = object : VoiceEngine.Listener {
            ...
            override fun onCommand(cmd: VoiceCommand) { FeedbackSounds.play(this@PlaybackService, app.config.feedbackSound, app.config.feedbackVolume, app.config.feedbackCustomPath); VoiceCommandRouter.dispatch(this@PlaybackService, cmd); Bg.post { uiListener?.onVoiceEvent("command", cmd.kind) } }
